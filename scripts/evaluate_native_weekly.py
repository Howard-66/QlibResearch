...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--validation-only-tradable", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--validation-risk-degree", type=float, default=0.95)
