...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "surface-floating fixed left-1/2 top-1/2 z-50 w-[min(96vw,56rem)] max-h-[90vh] -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-border/70 p-6 shadow-xl",
        className,
      )}
      {...props}
    >
