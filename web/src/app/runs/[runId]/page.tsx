          ...
          <DataTable
            table={{
              columns: [
                ...
                "walk_forward_score_distinction",
                "walk_forward_top1_sector_weight",
              ...
              rows: detail.recipes.map((recipe) => ({
                ...
                walk_forward_score_distinction: formatPercent(recipe.walk_forward_score_distinction, 2),
                walk_forward_top1_sector_weight: formatPercent(recipe.walk_forward_top1_sector_weight, 2),
